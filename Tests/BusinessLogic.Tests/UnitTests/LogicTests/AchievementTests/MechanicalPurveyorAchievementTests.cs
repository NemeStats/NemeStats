...
{
    [TestFixture]
    public class MechanicalPurveyorAchievementTests
    {
        private RhinoAutoMocker<MechanicalPurveyorAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<MechanicalPurveyorAchievement>();
        }
                                ...
                                BoardGameGeekGameDefinition = new BoardGameGeekGameDefinition
                                {
                                    Mechanics = new List<BoardGameGeekGameMechanic>
                                    {
                                        new BoardGameGeekGameMechanic
                                            {
                                                MechanicName = string.Format("MechanicName {0}", j)
                                            }
                                        }
                                }
                            }
