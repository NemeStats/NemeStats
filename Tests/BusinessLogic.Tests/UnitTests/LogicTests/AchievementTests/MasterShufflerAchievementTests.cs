...
{
    [TestFixture]
    public class MasterShufflerAchievementTests
    {
        private RhinoAutoMocker<MasterShufflerAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<MasterShufflerAchievement>();
        }
