...
{
    [TestFixture]
    public class DominionsChildAchievementTests
    {
        private RhinoAutoMocker<DominionsChildAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<DominionsChildAchievement>();
        }
                                ...
                                BoardGameGeekGameDefinition = new BoardGameGeekGameDefinition
                                {
                                    Mechanics = new List<BoardGameGeekGameMechanic>
                                    {
                                        new BoardGameGeekGameMechanic
                                            {
                                                MechanicName = "Deck / Pool Building"
                                            }
                                        }
                                }
                            }
