...
{
    [TestFixture]
    public class YouveGotHeartAchievementTests
    {
        private RhinoAutoMocker<YouveGotHeartAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<YouveGotHeartAchievement>();
        }
        ...
        [Test]
        public void ItDoesNotAwardTheAchievementWhenThePlayerHasAWin()
        {
            //--arrange
            SetupGamesForPlayer(_playerId, _autoMocker.ClassUnderTest.LevelThresholds[AchievementLevel.Bronze] - 1, true);
