...
{
    [TestFixture]
    public class WargamerAchievementTests
    {
        private RhinoAutoMocker<WargamerAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<WargamerAchievement>();
        }
