...
{
    [TestFixture]
    public class MeepleMasterAchievementTests
    {
        private RhinoAutoMocker<MeepleMasterAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<MeepleMasterAchievement>();
        }
