...
{
    [TestFixture]
    public class ReallyGoodGuesserAchievementTests
    {
        private RhinoAutoMocker<ReallyGoodGuesserAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<ReallyGoodGuesserAchievement>();
        }
