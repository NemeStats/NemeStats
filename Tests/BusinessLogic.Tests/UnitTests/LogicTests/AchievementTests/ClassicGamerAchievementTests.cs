...
{
    [TestFixture]
    public class ClassicGamerAchievementTests
    {
        private RhinoAutoMocker<ClassicGamerAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<ClassicGamerAchievement>();
        }
