...
{
    [TestFixture]
    public class CivBuilderAchievementTests
    {
        private RhinoAutoMocker<CivBuilderAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<CivBuilderAchievement>();
        }
