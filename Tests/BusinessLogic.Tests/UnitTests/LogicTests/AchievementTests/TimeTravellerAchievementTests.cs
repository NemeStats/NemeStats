...
{
    [TestFixture]
    public class TimeTravellerAchievementTests
    {
        private RhinoAutoMocker<TimeTravellerAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<TimeTravellerAchievement>();
        }
