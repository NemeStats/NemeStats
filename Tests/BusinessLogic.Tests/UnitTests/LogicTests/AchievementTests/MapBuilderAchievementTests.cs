...
{
    [TestFixture]
    public class MapBuilderAchievementTests
    {
        private RhinoAutoMocker<MapBuilderAchievement> _autoMocker;
        private readonly int _playerId = 1;

        [SetUp]
        public void SetUp()
        {
            _autoMocker = new RhinoAutoMocker<MapBuilderAchievement>();
        }
