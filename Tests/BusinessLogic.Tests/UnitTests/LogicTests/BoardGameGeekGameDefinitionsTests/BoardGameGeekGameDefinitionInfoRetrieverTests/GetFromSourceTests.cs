    ...
    public class BoardGameGeekGameDefinitionInfoRetrieverTests
    {
        ...
        public class When_Calling_GetFromSource : BoardGameGeekGameDefinitionInfoRetrieverTests
        {
            ...
            public void It_Throws_An_Entity_Does_Not_Exist_Exception_If_The_BoardGameGeekGameDefinitionId_Isnt_Valid()
            {
                //--arrange
                int invalidId = -1;
                var expectedException = new EntityDoesNotExistException<BoardGameGeekGameDefinition>(invalidId);

                //--act
                var exception = Assert.Throws<EntityDoesNotExistException<BoardGameGeekGameDefinition>>(() => AutoMocker.ClassUnderTest.GetFromSource(invalidId));
