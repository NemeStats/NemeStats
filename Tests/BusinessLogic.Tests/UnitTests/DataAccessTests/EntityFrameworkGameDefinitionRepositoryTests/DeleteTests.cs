...
namespace BusinessLogic.Tests.UnitTests.DataAccessTests.EntityFrameworkGameDefinitionRepositoryTests
{
    ...
    public class DeleteTests : EntityFrameworkGameDefinitionRepositoryTestBase
    {
        ...
        {
            gameDefinitionRepositoryPartialMock.Expect(mock => mock.GetGameDefinition(gameDefinition.Id, dbContextMock, userContext))
                .Repeat.Once()
                .Return(gameDefinition);

            gameDefinitionRepositoryPartialMock.Delete(gameDefinition.Id, dbContextMock, userContext);
