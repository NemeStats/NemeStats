...
{
    public partial class UniversalGameController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected UniversalGameController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UniversalGameController Actions { get { return MVC.UniversalGame; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "UniversalGame";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "UniversalGame";
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                ...
                public readonly string _UniversalGameStats = "_UniversalGameStats";
                public readonly string Details = "Details";
            }
            public readonly string _BoardGameGeekInfo = "~/Views/UniversalGame/_BoardGameGeekInfo.cshtml";
            public readonly string _UniversalGameStats = "~/Views/UniversalGame/_UniversalGameStats.cshtml";
            public readonly string Details = "~/Views/UniversalGame/Details.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UniversalGameController : UI.Controllers.UniversalGameController
    {
        public T4MVC_UniversalGameController() : base(Dummy.Instance) { }
