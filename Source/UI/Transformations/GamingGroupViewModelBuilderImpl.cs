...
{
    public class GamingGroupViewModelBuilderImpl : GamingGroupViewModelBuilder
    {
        private GamingGroupInvitationViewModelBuilder invitationViewModelTransformer;
        private PlayerDetailsViewModelBuilder playerDetailsViewModelBuilder;
        private PlayedGameDetailsViewModelBuilder playedGameDetailsViewModelBuilder;

        public GamingGroupViewModelBuilderImpl(
            GamingGroupInvitationViewModelBuilder invitationViewModelTransformer,
            PlayerDetailsViewModelBuilder playerDetailsViewModelBuilder,
            PlayedGameDetailsViewModelBuilder playedGameDetailsViewModelBuilder)
        {
