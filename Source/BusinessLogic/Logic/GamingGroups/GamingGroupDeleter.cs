...
{
    public class GamingGroupDeleter : TransactionalComponentBase<int>, IGamingGroupDeleter
    {
        private readonly IDataContext _dataContext;
        private readonly ISecuredEntityValidator _securedEntityValidator;

        public GamingGroupDeleter(IDataContext dataContext, ISecuredEntityValidator securedEntityValidator)
        {
