...
namespace BusinessLogic.DataAccess
{
    public interface DataContext : IDisposable
    {
        ...
        IQueryable<TEntity> GetQueryable<TEntity>(ApplicationUser currentUser) where TEntity : class, EntityWithTechnicalKey;
        TEntity FindById<TEntity>(object id, ApplicationUser currentUser) where TEntity : class, EntityWithTechnicalKey;
